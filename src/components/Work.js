  ...
  return (
    <div id="work">
      ...
      <div className="day-trading">
        ...
        <a href="https://en.wikipedia.org/wiki/Day_trading" target="_blank"><h3 className="company">Day Trading</h3></a>
      ...
      <div className="christofferson">
        ...
        <a href="https://www.christoffersonmoving.com/" target="_blank"><h3 className="company">Christofferson Moving and Storage</h3></a>
