  ...
  return (
    <div id="projects" className="hidden">
      ...
      <li className="projects-container">
        <ul>
          <section><a href="https://nicks-sortingalgo.herokuapp.com/" target="_blank" rel="noreferrer">Sorting Algorithm Visualizer</a>
          ...
          <div className="sorting">
            ...
            <a href="https://nicks-sortingalgo.herokuapp.com/" target="_blank" rel="noreferrer"><img src={sorting} className="sortingSS" alt="Screenshot of my sorting visualizer"></img></a>
          </div>
        </ul>
        <ul>
          <section><a href="https://nicks-fec-deploy-test.herokuapp.com/" target="_blank" rel="noreferrer">Frontend Capstone</a>
          <a href="https://github.com/RFCE2209Targaryen/FEC" target="_blank" rel="noreferrer"><img className="github" src={Github} alt="Github logo"></img></a>
          </section>
          <div className="fec">
            ...
            <a href="https://nicks-fec-deploy-test.herokuapp.com/" target="_blank" rel="noreferrer"><img src={fec} className="fecSS" alt="Screenshot of my front-end capstone"></img></a>
          </div>
        </ul>
      </li >
    </div >
